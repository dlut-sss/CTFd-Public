...
class ServerConfig(object):
    ...
    if DATABASE_URL.startswith("sqlite") is False:
        SQLALCHEMY_ENGINE_OPTIONS = {
            "pool_size": int(empty_str_cast(config_ini["optional"]["SQLALCHEMY_POOL_SIZE"], default=500)),
            "max_overflow": int(empty_str_cast(config_ini["optional"]["SQLALCHEMY_MAX_OVERFLOW"], default=500)),
            # noqa: E131
